...
func (c *analyticsServiceClient) GetAnalyticsForEachUserOnWhichTasksIsHeCurrentlyOn(ctx context.Context, in *AnalyticsForEachUserOnWhichTasksIsHeCurrentlyOnRequest, opts ...grpc.CallOption) (*TaskIdsListRespnse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TaskIdsListRespnse)
