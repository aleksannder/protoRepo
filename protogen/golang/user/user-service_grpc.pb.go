...
func (c *userServiceClient) GetAllUsersByProjectId(ctx context.Context, in *GetAllUsersByProjectIdRequest, opts ...grpc.CallOption) (*GetAllUsersByProjectIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetAllUsersByProjectId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) RemoveUserFromProject(ctx context.Context, in *AddUserToProjectRequest, opts ...grpc.CallOption) (*AddUserToProjectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddUserToProjectResponse)
	err := c.cc.Invoke(ctx, UserService_RemoveUserFromProject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
