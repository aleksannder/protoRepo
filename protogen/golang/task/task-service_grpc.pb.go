...
type TaskServiceClient interface {
	...
	DocumentDownload(ctx context.Context, in *DownloadDocumentRequest, opts ...grpc.CallOption) (TaskService_DocumentDownloadClient, error)
}
...
func (c *taskServiceClient) InsertTask(ctx context.Context, in *InsertTaskRequest, opts ...grpc.CallOption) (*InsertTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_InsertTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) ChangeTaskState(ctx context.Context, in *ChangeTaskStateRequest, opts ...grpc.CallOption) (*FindTaskByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_ChangeTaskState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) FindAllTasks(ctx context.Context, in *FindAllTasksRequest, opts ...grpc.CallOption) (*FindAllTasksResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_FindAllTasks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) FindAllTasksByProjectID(ctx context.Context, in *FindAllTasksByProjectIDRequest, opts ...grpc.CallOption) (*FindAllTasksByProjectIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_FindAllTasksByProjectID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) DocumentUpload(ctx context.Context, opts ...grpc.CallOption) (TaskService_DocumentUploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[0], TaskService_DocumentUpload_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &taskServiceDocumentUploadClient{stream}
	return x, nil
}

type TaskService_DocumentUploadClient interface {
	Send(*httpbody.HttpBody) error
	CloseAndRecv() (*UploadResponse, error)
	grpc.ClientStream
}

type taskServiceDocumentUploadClient struct {
	grpc.ClientStream
}

func (x *taskServiceDocumentUploadClient) Send(m *httpbody.HttpBody) error {
	return x.ClientStream.SendMsg(m)
}

func (x *taskServiceDocumentUploadClient) CloseAndRecv() (*UploadResponse, error) {
...
func (c *taskServiceClient) DocumentDownload(ctx context.Context, in *DownloadDocumentRequest, opts ...grpc.CallOption) (TaskService_DocumentDownloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[1], TaskService_DocumentDownload_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &taskServiceDocumentDownloadClient{stream}
...
type TaskService_DocumentDownloadClient interface {
	Recv() (*httpbody.HttpBody, error)
	grpc.ClientStream
}

type taskServiceDocumentDownloadClient struct {
	grpc.ClientStream
}

func (x *taskServiceDocumentDownloadClient) Recv() (*httpbody.HttpBody, error) {
...
type TaskServiceServer interface {
	...
	DocumentDownload(*DownloadDocumentRequest, TaskService_DocumentDownloadServer) error
...
func (UnimplementedTaskServiceServer) DocumentUpload(TaskService_DocumentUploadServer) error {
	return status.Errorf(codes.Unimplemented, "method DocumentUpload not implemented")
}
func (UnimplementedTaskServiceServer) DocumentDownload(*DownloadDocumentRequest, TaskService_DocumentDownloadServer) error {
...
func _TaskService_DocumentUpload_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TaskServiceServer).DocumentUpload(&taskServiceDocumentUploadServer{stream})
}

type TaskService_DocumentUploadServer interface {
	SendAndClose(*UploadResponse) error
	Recv() (*httpbody.HttpBody, error)
	grpc.ServerStream
}

type taskServiceDocumentUploadServer struct {
	grpc.ServerStream
}

func (x *taskServiceDocumentUploadServer) SendAndClose(m *UploadResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *taskServiceDocumentUploadServer) Recv() (*httpbody.HttpBody, error) {
	m := new(httpbody.HttpBody)
...
func _TaskService_DocumentDownload_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TaskServiceServer).DocumentDownload(m, &taskServiceDocumentDownloadServer{stream})
}

type TaskService_DocumentDownloadServer interface {
	Send(*httpbody.HttpBody) error
	grpc.ServerStream
}

type taskServiceDocumentDownloadServer struct {
	grpc.ServerStream
}

func (x *taskServiceDocumentDownloadServer) Send(m *httpbody.HttpBody) error {
	return x.ServerStream.SendMsg(m)
}
